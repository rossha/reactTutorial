...
var Footer = (function (_React$Component) {
  ...
  function Footer(props) {
    ...
    // In ES6, component methods do not autobind 'this' context. This line explicitly binds it.
    this.onChange = this.onChange.bind(this);
  }
    ...
    value: function handleSubmit(event) {
      ...
      if (searchQuery) {
        _actionsNavbarActions2['default'].findCharacter({
          ...
          // pass is a reference to the search field DOM Node so it can be animated to shake if no results are found.
